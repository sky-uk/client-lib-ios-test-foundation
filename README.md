...
Test suite for iOS mobile applications: a collection of tools and classes to to facilitate the writing of automatic tests during development of an iOS mobile application.
