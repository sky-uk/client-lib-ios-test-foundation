## Contributing to Sky Test Foundation

Thank you for your interest in Sky Test Foundation! There are multiple ways you can contribute to this project. We welcome contributions in all areas, with special attention to:
...
All contributions are handled via Pull Requests (PRs). Your PR _must_ target the `develop` branch. This is the place where we aggregate all upcoming changes for the next release of Sky Test Foundation. Moreover, your PR _must_ provide a meaningful description of what it is about.
...
Being able to express tests declaratively, elegantly and shortly is not an easy task and there's always room left for improvement. If you think you can improve how to write a test in Sky Test Foundation, create a new issue and explain with as much as details as possible, how your idea can improve the library, highlighting the advantages over the current approach and eventual tradeoffs. Discussing the matter via an issue is a preferred starting point. This will allow other contributors to join and express their point of view, allowing for a smooth glide from problem description to resolution.

### Performance improvements

We take performance very much to heart. Sky Test Foundation is at the core of some large products. Performance improvements are always welcome! If you identified a bottleneck, please make sure you follow the performance fix procedure:
...
Thanks for caring about performance! Sky Test Foundation is a crucial component of many applications and performance issues can have a wide impact.

### Documentation improvements

Sky Test Foundation is a complex testing library, which allows for a variety of different use cases. Documenting them providing examples is crucial for library adoption. The more examples and scenarios, the better. Obviously, it's not possibile to document every single use case in the world, but we aim to document most common scenarios and usages, promoting best practices through examples. We very much need a documentation that is as good, as as up-to-date as possible!
